...
import { MotionDiv, MotionH2, MotionH3 } from "./MotionWrapper";
  ...
  const steps: Step[] = [
    {
      ...
      description:
        "Drag & drop or select your PDF — SummizeIt handles the rest.",
    },
    {
      icon: <BrainCircuit size={64} strokeWidth={1.5} />,
      label: "AI-Powered Analysis",
      description:
        "Let SummizeIt's intelligent engine analyze and understand your content in seconds.",
    },
    {
      icon: <FileOutput size={64} strokeWidth={1.5} />,
      label: "Instant Summary",
      description:
        "Get a clean, concise summary — perfect for fast reading and deeper insights.",
    },
  ];
      ...
      <div className="py-12 lg:py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div
            ...
            style={{
              clipPath:
                "polygon(74.1% 44.1%, 100% 61.4%, 97.5% 26.9%, 85.5% 14.6%, 80.7% 72.5%, 32.5% 62.2%, 54.2% 68.1%, 47.5% 58.3%, 34.7% 85.5%, 30.2% 78.1%, 9% 17.9%, 27.6% 76%, 76.1% 97.1%, 74.1% 44.1%)",
            }}
          />
        </div>
        ...
        <div className="text-center mb-16">
          ...
          >
            Turn any PDF into a clear, AI-powered summary in just three simple
            steps.
          </MotionH3>
        </div>
